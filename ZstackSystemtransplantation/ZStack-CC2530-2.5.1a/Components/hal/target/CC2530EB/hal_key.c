...
{                                         //OnBoard_KeyCallback
  ...
  if (Hal_KeyIntEnable)
  {
     ...
     */
    HAL_KEY_SW_6_ICTL |= HAL_KEY_SW_6_ICTLBIT;  //P0_4中断使能
    HAL_KEY_SW_6_IEN |= HAL_KEY_SW_6_IENBIT;   //端口0中断使能
    HAL_KEY_SW_6_PXIFG = ~(HAL_KEY_SW_6_BIT);  //清除P0_4的中断标志位
